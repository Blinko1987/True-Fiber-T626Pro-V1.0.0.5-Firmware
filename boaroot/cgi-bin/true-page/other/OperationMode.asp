<%
if tcWebApi_get("XPON_Common","web_role_flag","h") <> "0" then
...
<% end if %>
<% if tcWebApi_get("XPON_Common","web_role_flag","h") = "0" then %> 
    document.getElementById('Role_Controller').disabled = true;
    document.getElementById('Role_Agent').disabled = true;
    document.getElementById('Role_Auto').disabled = true;
<% end if %>
    });
