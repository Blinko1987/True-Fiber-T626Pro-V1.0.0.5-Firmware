...
<% end if%>
	...
	//msx
	Dongle_ConStatus="<% tcWebApi_get("Dongle_Info","ConnectStatus","s") %>";
	if(Dongle_ConStatus == "1")
	{
		DongleWan_Status ="<% tcWebApi_get("Dongle_Common","NetworkEnable","s") %>";
		
		DongleWan_IP4="<% tcWebApi_get("Dongle_Info","IPv4Address","s") %>";
		DongleWan_DNS4="<% tcWebApi_get("Dongle_Info","IPv4PriDns","s") %>";
		DongleWan_SecDNS4="<% tcWebApi_get("Dongle_Info","IPv4SecDns","s") %>";
		
		DongleWan_IP6="<% tcWebApi_get("Dongle_Info","IPv6Address","s") %>";
		DongleWan_DNS6="<% tcWebApi_get("Dongle_Info","IPv6PriDns","s") %>";
		DongleWan_SecDNS6="<% tcWebApi_get("Dongle_Info","IPv6SecDns","s") %>";
	}
	else
	{
		DongleWan_Status = null;
		
		DongleWan_IP4= null;
		DongleWan_DNS4= null;
		DongleWan_SecDNS4= null;
		DongleWan_IP6= null;
		DongleWan_DNS6= null;
		DongleWan_SecDNS6= null;
	}
    ...
    function getSpecificIndex_reconnect()
    {
      ...
      validifindex_Array = SortUtil.SortMyArray( validifindex_Array );
        ...
        {
          var mcWanName = matchWanName(reg, AllWanName_Array[i]);
          if (mcWanName != null)
          {
            if (mcWanName == "INTERNET")
            {
              internet_wan_index = validifindex_Array[i];
              ListCreatIndex = i;
            }
            else if (mcWanName == "TR069_INTERNET")
            {
    ...
    function ListCreate_info1()
    {
      ...
      if ( ListCreatIndex != -1)
      {
        if(Wan_Actives[ListCreatIndex] != "N/A")
        {
          ...
          {
            if(Wan_IPVERSION[ListCreatIndex] == "IPv4" && ( Wan_Status4[ListCreatIndex] == "connected" || Wan_Status4[ListCreatIndex] == "up"))
            {
              document.writeln("<div class='row'>");
              document.writeln("<div class='col-6'><div class='sub-title-dashboard-left'>IP Address:</div></div>");document.writeln("<div class='col-6' ><div class='sub-title-dashboard-right' id='wanip4'>" + Wan_IP4[ListCreatIndex] + "</div></div>");
            ...
            else if(Wan_IPVERSION[ListCreatIndex] == "IPv6" && ( Wan_Status6[ListCreatIndex] == "connected" || Wan_Status6[ListCreatIndex] == "up"))
            {
              document.writeln("<div class='row'>");
            ...
            {
              if(Wan_Status4[ListCreatIndex] == "connected" || Wan_Status4[ListCreatIndex] == "up"){
				  document.writeln("<div class='row'>");
              ...
              if(Wan_Status6[ListCreatIndex] == "connected" || Wan_Status6[ListCreatIndex] == "up"){
				  document.writeln("<div class='row'>");
		          document.writeln("<div class='col-6'><div class='sub-title-dashboard-left'>IPv6 Address:</div></div>");
		          document.writeln("<div class='col-6'><div class='sub-title-dashboard-right' id='wanip6'>" + Wan_IP6[ListCreatIndex] + "</div></div>");
				  document.writeln("</div>");
...
<% end if%>
		...
		//msx
		if(DongleWan_Status == "ppp_connected"||DongleWan_Status == "ipv6_connected"||DongleWan_Status == "ipv4_ipv6_connected")
        {
          document.getElementById("offline").style.display = "none";
          document.getElementById("online").style.display = "block";
		  console.log("351"); 

		  if(DongleWan_Status == "ppp_connected")
		  {
		    document.writeln("<div class='row'>");
		    document.writeln("<div class='col-6'><div class='sub-title-dashboard-left'>IP Address:</div></div>");
		  	document.writeln("<div class='col-6' ><div class='sub-title-dashboard-right' id='wanip4'>" + DongleWan_IP4 + "</div></div>");
			document.writeln("</div>");

			document.writeln("<div class='row'>");
		    document.writeln("<div class='col-6'><div class='sub-title-dashboard-left'>DNS IP Address:</div></div>");
			document.writeln("<div class='col-6' ><div class='sub-title-dashboard-right' id='wandns4'>" + DongleWan_DNS4 + "</div></div>");
			document.writeln("</div>");
			if("N/A" != DongleWan_SecDNS4 && '-' != DongleWan_SecDNS4){
				document.writeln("<div class='row' id ='secdns4'>");
				document.writeln("<div class='col-6'><div class='sub-title-dashboard-left'>Second DNS:</div></div>");
				document.writeln("<div class='col-6' ><div class='sub-title-dashboard-right' id='wansecdns4'>" + DongleWan_SecDNS4 + "</div></div>");
				document.writeln("</div>");
			}
		 }
		  else if(DongleWan_Status == "ipv6_connected"){
		    document.writeln("<div class='row'>");
		    document.writeln("<div class='col-6'><div class='sub-title-dashboard-left'>IPv6 Address:</div></div>");
		  	document.writeln("<div class='col-6' ><div class='sub-title-dashboard-right' id='wanip6'>" + DongleWan_IP6 + "</div></div>");
			document.writeln("</div>");
			
			document.writeln("<div class='row'>");
		    document.writeln("<div class='col-6'><div class='sub-title-dashboard-left'>DNS IPv6 Address:</div></div>");
			document.writeln("<div class='col-6' ><div class='sub-title-dashboard-right' id='wandns6'>" + DongleWan_DNS6 + "</div></div>");
			document.writeln("</div>");
			
			if("N/A" != DongleWan_SecDNS6 && '-' != DongleWan_SecDNS6){
				document.writeln("<div class='row' id ='secdns4'>");
				document.writeln("<div class='col-6'><div class='sub-title-dashboard-left'>Second DNS:</div></div>");
				document.writeln("<div class='col-6' ><div class='sub-title-dashboard-right' id='wansecdns4'>" + DongleWan_SecDNS6 + "</div></div>");
				document.writeln("</div>");
			}
		  ...
		  else
		  {
			...
			if("N/A" != DongleWan_SecDNS6 && '-' != DongleWan_SecDNS6){
				document.writeln("<div class='row' id ='secdns6'>");
				document.writeln("<div class='col-6'><div class='sub-title-dashboard-left'>Second DNS:</div></div>");
				document.writeln("<div class='col-6' ><div class='sub-title-dashboard-right' id='wansecdns6'>" + DongleWan_SecDNS6 + "</div></div>");
				document.writeln("</div>");
			}
		   }
        }
...
<% end if%>
  ...
  function check_internet_wan_dns()
  {
    ...
    for(i = 0; i < nEntryNum; i++)
    {
      var mcWanName = matchWanName(reg, Wan_WanName[i]);
      if (mcWanName != null)
      {
        if (mcWanName == "TR069_INTERNET")
        {
    ...
    //msx
	  if(DongleWan_Status == "ppp_connected"||DongleWan_Status == "ipv6_connected"||DongleWan_Status == "ipv4_ipv6_connected")
      {
		  document.getElementById("DnsCheck").style.width = '100%';
      	  document.getElementById("DnsCheck").className="progress-success-status"
      	  document.getElementById("DnsImg").src= "/image/icon/check_circle.svg";
		  var Dongle_v4Dns = "<% tcWebApi_get("Dongle_Info","IPv4PriDns", "s") %>";
		  $("#dnstext").text(Dongle_v4Dns);
	  }
  }
