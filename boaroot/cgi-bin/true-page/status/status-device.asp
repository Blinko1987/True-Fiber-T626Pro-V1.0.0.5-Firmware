...
<head>
  ...
  <SCRIPT language=JavaScript type=text/javascript>
    ...
    var Wan_ipv6rd = vArrayStr.slice(0, -1).split(',');
    ...
    Wan_ipv6rd = SortUtil.SortMyArray( Wan_ipv6rd );
...
<% end if %>
      ...
      if(tr069WAN_index != -1 && Wan_IP6[tr069WAN_index] != "N/A" && Wan_IP6[tr069WAN_index] != "" && Wan_IP6[tr069WAN_index] != "-")
      {
        selectwanif = IFIdxArray[tr069WAN_index];
        selectindex = tr069WAN_index;
      }
      else
      {
        if(internetWAN_index != -1 && Wan_IP6[tr069WAN_index] != "N/A" && Wan_IP6[tr069WAN_index] != "" && Wan_IP6[tr069WAN_index] != "-")
        {
          selectwanif = IFIdxArray[internetWAN_index];
          selectindex = internetWAN_index;
        }
        else
        {
          if(rd6WAN_index != -1 && Wan_IP6[tr069WAN_index] != "N/A" && Wan_IP6[tr069WAN_index] != "" && Wan_IP6[tr069WAN_index] != "-")
          {
            selectwanif = IFIdxArray[rd6WAN_index];
            selectindex = rd6WAN_index;
          }
        }
      }
    }
    ...
    function get_IPv6_Prefix_Delegate()
    {
      var result = "-";
      ...
      if(Wan_PD6[selectindex] != "N/A" && Wan_PD6[selectindex] != "" && Wan_PD6[selectindex] != "-")
        result = Wan_PD6[selectindex];
        ...
        <table style="width:100%">
          ...
          <tr class="table-content-fist">
            ...
            <SCRIPT language=JavaScript type=text/javascript>
                ...
                */
                document.write(get_IPv6_Address());
            </script>
            </td>
          </tr>
          <tr class="table-content-second">
          ...
          <tr class="table-content-fist">
              ...
              <SCRIPT language=JavaScript type=text/javascript>
                ...
                document.write(get_IPv6_Prefix_Delegate());
              </SCRIPT>
              </td>
          </tr>
        </table>
