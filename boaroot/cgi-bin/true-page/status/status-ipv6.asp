...
<%if tcWebApi_get("Dongle_Info","ConnectStatus","h" ) = "1" then%>
	 var DongleWan_Status="<% tcWebApi_get("Dongle_Common","NetworkEnable","s") %>";
	 if(DongleWan_Status == "ipv6_connected"||DongleWan_Status == "ipv4_ipv6_connected")
	 {
		if(num % 2 == 0)
        {
          document.write('<tr class="table-content-fist center">');
        ...
        num = num + 1 ;
        document.write('<td class="p-1">' + "eth1" + '</td>');
        document.write('<td>' + "-" + '</td>');
		document.write('<td>' + "INTERNET" + '</td>');
		document.write('<td>' + "-" + '</td>');
		var DongleWan_IP6="<% tcWebApi_get("Dongle_Info","IPv6Address","s") %>";
        document.write('<td>' + DongleWan_IP6 + '</td>');
		document.write('<td>up</td>');
	 }
<%end if%>
    }
...
<%if tcWebApi_get("Dongle_Info","ConnectStatus","h" ) = "1" then%>
	 var DongleWan_Status="<% tcWebApi_get("Dongle_Common","NetworkEnable","s")%>";
	 if(DongleWan_Status == "ppp_connected"||DongleWan_Status == "ipv4_ipv6_connected")
	 {
		if(num % 2 == 0)
        {
          document.write('<tr class="table-content-fist center">');
		...
		{
			document.write('<td>' + "PPPoE" + '</td>');
		}else
		{
			document.write('<td>' + "-" + '</td>');
		}
		var DongleWan_IP4="<% tcWebApi_get("Dongle_Info","IPv4Address","s") %>";
        document.write('<td>' + DongleWan_IP4 + '</td>');
		DongleWan_DNS4="<% tcWebApi_get("Dongle_Info","IPv4PriDns","s") %>";
		document.write('<td>' + DongleWan_DNS4 + '</td>');
		document.write('<td>up</td>');
	 }
<%end if%>
    }
