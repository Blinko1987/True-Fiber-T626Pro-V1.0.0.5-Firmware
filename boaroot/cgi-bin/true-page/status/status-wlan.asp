...
<head>
  ...
  <SCRIPT language=JavaScript type=text/javascript>
	...
	function getValidClientNum(index)
	{
		var clientNum = 0;
		var wifitab_pvc = '';
		...
		{
			case 0:
				clientNum = parseInt('<% if tcWebApi_get("wifiMacTab_Common","NUM0","h") <> "N/A" then tcWebApi_get("wifiMacTab_Common","NUM0","s") else asp_Write("0") end if %>');
				wifitab_pvc = '<% tcWebApi_GetTable("wifiMacTab_PVC0", "Entry", "0,63") %>';
				break;
			case 1:
				clientNum = parseInt('<% if tcWebApi_get("wifiMacTab_Common","NUM1","h") <> "N/A" then tcWebApi_get("wifiMacTab_Common","NUM1","s") else asp_Write("0") end if %>');
				wifitab_pvc = '<% tcWebApi_GetTable("wifiMacTab_PVC1", "Entry", "0,63") %>';
				break;
			case 2:
				clientNum = parseInt('<% if tcWebApi_get("wifiMacTab_Common","NUM2","h") <> "N/A" then tcWebApi_get("wifiMacTab_Common","NUM2","s") else asp_Write("0") end if %>');
				wifitab_pvc = '<% tcWebApi_GetTable("wifiMacTab_PVC2", "Entry", "0,63") %>';
				break;
			case 3:
				clientNum = parseInt('<% if tcWebApi_get("wifiMacTab_Common","NUM3","h") <> "N/A" then tcWebApi_get("wifiMacTab_Common","NUM3","s") else asp_Write("0") end if %>');
				wifitab_pvc = '<% tcWebApi_GetTable("wifiMacTab_PVC3", "Entry", "0,63") %>';
				break;
			case 4:
				clientNum = parseInt('<% if tcWebApi_get("wifiMacTab_Common","NUM4","h") <> "N/A" then tcWebApi_get("wifiMacTab_Common","NUM4","s") else asp_Write("0") end if %>');
				wifitab_pvc = '<% tcWebApi_GetTable("wifiMacTab_PVC4", "Entry", "0,63") %>';
				break;
			case 5:
				clientNum = parseInt('<% if tcWebApi_get("wifiMacTab_Common","NUM5","h") <> "N/A" then tcWebApi_get("wifiMacTab_Common","NUM5","s") else asp_Write("0") end if %>');
				wifitab_pvc = '<% tcWebApi_GetTable("wifiMacTab_PVC5", "Entry", "0,63") %>';
				break;
			case 6:
				clientNum = parseInt('<% if tcWebApi_get("wifiMacTab_Common","NUM6","h") <> "N/A" then tcWebApi_get("wifiMacTab_Common","NUM6","s") else asp_Write("0") end if %>');
				wifitab_pvc = '<% tcWebApi_GetTable("wifiMacTab_PVC6", "Entry", "0,63") %>';
				break;
			case 7:
				clientNum = parseInt('<% if tcWebApi_get("wifiMacTab_Common","NUM7","h") <> "N/A" then tcWebApi_get("wifiMacTab_Common","NUM7","s") else asp_Write("0") end if %>');
				wifitab_pvc = '<% tcWebApi_GetTable("wifiMacTab_PVC7", "Entry", "0,63") %>';
				break;
			case 8:
				clientNum = parseInt('<% if tcWebApi_get("wifiMacTab_Common","NUM8","h") <> "N/A" then tcWebApi_get("wifiMacTab_Common","NUM8","s") else asp_Write("0") end if %>');
				wifitab_pvc = '<% tcWebApi_GetTable("wifiMacTab_PVC8", "Entry", "0,63") %>';
				break;
			case 9:
				clientNum = parseInt('<% if tcWebApi_get("wifiMacTab_Common","NUM9","h") <> "N/A" then tcWebApi_get("wifiMacTab_Common","NUM9","s") else asp_Write("0") end if %>');
				wifitab_pvc = '<% tcWebApi_GetTable("wifiMacTab_PVC9", "Entry", "0,63") %>';
				break;
			case 10:
				clientNum = parseInt('<% if tcWebApi_get("wifiMacTab_Common","NUM10","h") <> "N/A" then tcWebApi_get("wifiMacTab_Common","NUM10","s") else asp_Write("0") end if %>');
				wifitab_pvc = '<% tcWebApi_GetTable("wifiMacTab_PVC10", "Entry", "0,63") %>';
				break;
			case 11:
				clientNum = parseInt('<% if tcWebApi_get("wifiMacTab_Common","NUM11","h") <> "N/A" then tcWebApi_get("wifiMacTab_Common","NUM11","s") else asp_Write("0") end if %>');
				wifitab_pvc = '<% tcWebApi_GetTable("wifiMacTab_PVC11", "Entry", "0,63") %>';
				break;
			case 12:
				clientNum = parseInt('<% if tcWebApi_get("wifiMacTab_Common","NUM12","h") <> "N/A" then tcWebApi_get("wifiMacTab_Common","NUM12","s") else asp_Write("0") end if %>');
				wifitab_pvc = '<% tcWebApi_GetTable("wifiMacTab_PVC12", "Entry", "0,63") %>';
				break;
			case 13:
				clientNum = parseInt('<% if tcWebApi_get("wifiMacTab_Common","NUM13","h") <> "N/A" then tcWebApi_get("wifiMacTab_Common","NUM13","s") else asp_Write("0") end if %>');
				wifitab_pvc = '<% tcWebApi_GetTable("wifiMacTab_PVC13", "Entry", "0,63") %>';
				break;
			case 14:
				clientNum = parseInt('<% if tcWebApi_get("wifiMacTab_Common","NUM14","h") <> "N/A" then tcWebApi_get("wifiMacTab_Common","NUM14","s") else asp_Write("0") end if %>');
				wifitab_pvc = '<% tcWebApi_GetTable("wifiMacTab_PVC14", "Entry", "0,63") %>';
				break;
			case 15:
				clientNum = parseInt('<% if tcWebApi_get("wifiMacTab_Common","NUM15","h") <> "N/A" then tcWebApi_get("wifiMacTab_Common","NUM15","s") else asp_Write("0") end if %>');
				wifitab_pvc = '<% tcWebApi_GetTable("wifiMacTab_PVC15", "Entry", "0,63") %>';
				break;
		}

		var list = JSON.parse(wifitab_pvc);
		var ValidClientNum = 0;
		for (var i = 0; i < clientNum; i++) {
			if(list[i] != "N/A" && parseInt(list[i]["RSSIA"]) >= -95) {
				++ValidClientNum;
			}
		}

		return ValidClientNum;
	}
    ...
    <% if tcWebApi_get("wifiMacTab_Common","refreshFlag","h") = "1" then %>
      ...
      var clientNum0 = getValidClientNum(0);//2.4G BH
      var clientNum1 = getValidClientNum(1);
      var clientNum2 = getValidClientNum(2);
      var clientNum3 = getValidClientNum(3);
      var clientNum4 = getValidClientNum(4);
      var clientNum5 = getValidClientNum(5);
      var clientNum6 = getValidClientNum(6);
      var clientNum7 = getValidClientNum(7);

      var clientNum8 = getValidClientNum(8);//5G BH
      var clientNum9 = getValidClientNum(9);
      var clientNum10 = getValidClientNum(10);
      <% if tcWebApi_get("vid_common", "skyvid","h") = "10" then %>
      var clientNum11 = getValidClientNum(11);
      var clientNum11 = 0;//"   .@ TrueHiSpeed"
      <% end if %>
      var clientNum12 = getValidClientNum(12);
      var clientNum13 = getValidClientNum(13);
      var clientNum14 = getValidClientNum(14);
      var clientNum15 = getValidClientNum(15);
    <% else %>
      var Bssid1 = "/";
      var Bssid2 = "/";
      var Bssid3 = "/";
