...
<head>
  ...
  <title>Diagnostics - Tracert</title>
  <!-- style -->
  ...
  function tracertCheck() {
    ...
    if(!isNetIpAddress(tracert_text))
    {
...
<body>
<!-- content -->
  <form id="TracertForm" name="TracertForm" method="post" action="/cgi-bin/true-page/diagnostics/tracert.asp">
  ...
  <input type="hidden" name="AddRoute_Tracert" value="">
    <div class="container-full container-resize-height">
      <div class="title-text">Traceroute Diagnostics</div>
